...
`chopin-core` provides the core high‑performance HTTP engine used by the Chopin suite. It implements a shared‑nothing, zero‑allocation request pipeline with per‑core workers and advanced socket handling.
